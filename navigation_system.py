...
class NavigationSystem(object):
	...
	#-------------------------------------------------------------------------#
	# A test function to force a ship to fly in a circle
	...
	# The update function. Anything that the navigation system should do each
	# iteration resides in here.
	def update(self, task):
		...
		if(target is not None):
			...
			self.goToLocation(Vec3(250,250,250))
